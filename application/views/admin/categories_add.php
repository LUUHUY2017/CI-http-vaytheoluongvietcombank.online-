            ...
            <div class="tile-body">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="Enter user name . . ." name="txtname" autocomplete="off" value="<?php echo set_value('txtname'); ?>" onchange="changetoslug(this.value)">
                </div>
                <div class="form-group">
                  <label class="control-label">Slug</label>
                  <input class="form-control" placeholder="Enter slug . . ." autocomplete="off" id="slugUrl" name="txtslug" value="<?php echo set_value('txtslug'); ?>">
                </div>
                <div class="form-group">
